        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                <div class="list-group" id="role-filter">
                    <g:set var="modifiedRoleList" value="${roleList?.clone() }" ng-init="modifiedRoleList={{roleList}}"/>
                    <g:set var="dummy" value="{{modifiedRoleList?.add([id: 0, authority: 'ROLE_NO_ROLE']) }}" />
                    <a href="#" class="list-group-item" data-value="{{role.id}}" ng-repeat="role in roleList">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <ul class="list-inline" style="margin-bottom: 0">
                            <li>
                                <g:checkBox name="dummy"  ng-click="selectUnselectUser()" 
